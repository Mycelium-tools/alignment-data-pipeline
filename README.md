...
- `constitution/constitution_sentient_beings.md` — the animal-welfare section-by-section reading, with one `## ` header per section (15 sections; the 2 meta sections are skipped for scenario generation).
