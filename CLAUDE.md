...
- `constitution/constitution_sentient_beings.md` — the animal-welfare reading, parsed by `## ` headers into 15 sections, each mapped to a `principle_id` (0–14) in the DAD pipeline. Ids 0 and 14 (`META_PRINCIPLE_IDS`) are meta sections skipped during annotation and scenario generation.
