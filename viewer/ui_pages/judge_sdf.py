"""SDF judge playground — placeholder. The SDF judge is a separate instrument from the
DAD judge (documents, not conversations) and its rubric is not yet designed."""
...
When `evals/rubric_sdf_v1.yaml` exists, this page will get the same treatment as the
